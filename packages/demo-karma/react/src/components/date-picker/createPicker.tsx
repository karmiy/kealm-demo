    ...
    renderPicker = ({ getPrefixCls }: ConfigConsumerProps) => {
      ...
      const calendar = (
        <TheCalendar
          ...
          onOk={props.onOk}
          onCancel={createChainedFunction(props.onCancel, this.clearSelection)}
      ...
      const inputIcon = (suffixIcon &&
        ...
        ))) || <i className={`salus-icon-calendar-o`} />;

      const dataOrAriaProps = getDataOrAriaProps(props);
      const input = ({ value: inputValue }: { value: moment.Moment | null }) => (
        <div className="salus-form-icon">
          <span>
          {inputIcon}
          </span>
          <input
            ...
            /*className={classNames(props.pickerInputClass, 'salus-form-control')}*/
            className={'salus-form-control'}
