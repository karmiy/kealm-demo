...
type rangeBtnCustoms = 'last24Hours' | 'last48Hours' | 'last72Hours' | 'today' | 'yesterday' |
                        'lastThreeDays' | 'lastSevenDays' | 'lastWeek' | 'lastTwoWeek' | 'lastMonth' | 'lastSixMonth';
type rangeBtnOptions = 'hours' | 'days' | 'lastDays' | 'lastWeeksAndMonths';
export type rangeBtnType = rangeBtnOptions | rangeBtnCustoms[];
...
export interface RangePickerProps extends PickerProps {
  ...
  onCancel?: () => void;
  showTime?: TimePickerProps | boolean;
  rangeBtnType?: rangeBtnType | rangeBtnType[]; // 快速选择的按钮类型
  showOperation?: boolean; // 是否显示自定义操作按钮
  ranges?: {
