...
export class MenuItem extends React.Component {
  ...
  getPrefixCls() {
    ...
    //去除salus-select-option-menu-item里的-menu
    const prefixCls = `${this.props.rootPrefixCls}`.includes('-menu') ? `${this.props.rootPrefixCls}`.replace(/-menu/, '') : `${this.props.rootPrefixCls}`;
