  ...
  render() {
    ...
    const prevIcon = (
      <span className={`${prefixCls}-tab-prev-icon`}>
        ...
        {/*<i className={`salus-icon-arrow-${prevIconType}-o ${prefixCls}-tab-prev-icon-target`}></i>*/}
      </span>
    );
    const nextIcon = (
      <span className={`${prefixCls}-tab-next-icon`}>
        {/*<Icon type={nextIconType} className={`${prefixCls}-tab-next-icon-target`} />*/}
        {/*<i className={`salus-icon-arrow-${nextIconType}-o ${prefixCls}-tab-prev-icon-target`}></i>*/}
      </span>
    );
