...
//import RcTabs, { TabPane } from 'rc-tabs';
import TabContent from '../rc-tabs/TabContent';
      ...
      React.Children.forEach(
        ...
        (child: React.ReactElement<any>, index) => {
          ...
          const closeIcon = closable ? (
            <i className='salus-icon-pop-close-o' onClick={e => this.removeTab(child.key as string, e)} />
          ) : null;
      ...
      if (!hideAdd) {
        tabBarExtraContent = (
          <span>
            ...
            <i className='salus-icon-pop-close-o' onClick={this.createNewTab} />
            {tabBarExtraContent}
          </span>
        );
      }
