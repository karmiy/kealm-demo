...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      if (this.$refs.listContentWrapper) {
        const listContentWrapperDom = this.$refs.listContentWrapper.$el || this.$refs.listContentWrapper;
  ...
  render() {
    ...
    const showItems = dataSource.map(item => {
      ...
      if (filter && filter.trim() && !this.matchFilter(renderedText, item) || !this.matchFilterKeys(item)) {
        return null;
      }
    ...
    const listBody = bodyDom || (
      ...
      >
        ...
        >
          ...
          <ul
              class={`${prefixCls}-content salus-scrollbar`}
              ref="listContentWrapper"
          >
              {showItems}
          </ul>
