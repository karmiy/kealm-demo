...
export default {
  ...
  methods: {
    ...
    getButtonOrIcon() {
      ...
      let node;
      if (!enterButton) {
        node = <i class='salus-icon-search-o'/>;
      } else if (
        enterButtonAsElement.tag === 'button' ||
        (enterButtonAsElement.componentOptions &&
          enterButtonAsElement.componentOptions.Ctor.extendOptions.__SL_BUTTON)
      ) {
        ...
        node = (
          <Button
            ...
            key="enterButton"
          >
            {enterButton === true ? <i class="salus-icon-search-o" /> : enterButton}
          </Button>
        );
      }
