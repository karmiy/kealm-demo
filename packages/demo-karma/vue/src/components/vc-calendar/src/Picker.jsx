...
const Picker = {
  props: {
    ...
    value: PropTypes.oneOfType([Date, Array, MomentType, PropTypes.arrayOf(MomentType)]),
    defaultValue: PropTypes.oneOfType([Date, Array, MomentType, PropTypes.arrayOf(MomentType)]),
  ...
  methods: {
    ...
    onCalendarSelect(value, cause = {}) {
      ...
      if (
        ...
        (!calendarProps.timePicker && cause.source !== 'dateInput' && !props.showOperation) ||
    ...
    getCalendarElement() {
      ...
      const extraProps = {
        ...
        on: {
          ...
          cancel: createChainedFunction(calendarEvents.cancel, this.onCalendarCancel),
  ...
  render() {
    ...
    const { sValue, sOpen, onCalendarSelect } = this;
