  ...
  methods: {
    ...
    onOk() {
      ...
      if (this.isAllowedDate(sSelectedValue)) {
        // 转换为date
        // this.__emit('ok', sSelectedValue ? (this.format === 'YYYY-MM-DD' ? sSelectedValue.startOf('day')._d : sSelectedValue._d) : undefined);
        //this.__emit('ok', sSelectedValue ? sSelectedValue._d : undefined);
