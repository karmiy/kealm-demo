...
import { Circle } from '../vc-progress/public_api';
  ...
  render() {
    ...
    if (showInfo) {
      ...
      if (format || (progressStatus !== 'exception' && progressStatus !== 'success')) {
        ...
        text = type !== 'circle' ? <i class="salus-icon-error-msg-o" /> : <i class="salus-icon-pop-close-o"/>;
      } else if (progressStatus === 'success') {
        text = type !== 'circle' ? <i class="salus-icon-step-done-o" /> : <i class="salus-icon-check-o" />;
      }
      progressInfo = (
      ...
      progress = (
        <div>
          <div class={`${prefixCls}-outer`}>
            <div class={`${prefixCls}-inner`} style={innerStyle}>
