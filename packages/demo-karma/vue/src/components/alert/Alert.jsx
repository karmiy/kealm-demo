...
export default {
    ...
    render() {
        const { prefixCls = 'salus-alert', banner, closing, closed, bodyStyle } = this;
        ...
        // banner模式默认为警告
        type = banner && type === undefined ? 'warning' : type || '';
        ...
        if (!iconType) {
            switch (type) {
                case 'success':
                    iconType = 'salus-icon-success';
                    break;
                case 'info':
                    iconType = 'salus-icon-notification';
                    break;
                case 'error':
                    iconType = 'salus-icon-error-msg';
                    break;
                case 'warning':
                    iconType = 'salus-icon-sign-mark';
                    break;
                default:
                    iconType = '';
            }
        ...
        const closeIcon = closable ? (
            <a onClick={this.handleClose} class={`${prefixCls}-close-icon`}>
                {closeText || <i class={'salus-icon-pop-close-o'} />}
            </a>
        ) : null;
        ...
        return closed ? null : (
            <transition {...transitionProps}>
                <div v-show={closing} class={alertCls} style={bodyStyle} data-show={closing}>
