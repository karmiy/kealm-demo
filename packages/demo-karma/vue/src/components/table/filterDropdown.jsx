import Menu, { SubMenu, Item as MenuItem } from '../vc-menu/public_api';
import closest from 'dom-closest';
import classNames from 'classnames';
import shallowequal from 'shallowequal';
import Dropdown from '../dropdown/public_api';
import Checkbox from '../checkbox/public_api';
import Radio from '../radio/public_api';
...
export default {
  ...
  methods: {
    ...
    setNeverShown(column) {
      ...
      const filterBelongToScrollBody = !!closest(rootNode, `.salus-table-scroll`);
    ...
    renderFilterIcon() {
      ...
      return filterIcon ? (
        ...
        <i class="salusicon salus-icon-multiple-selection" title={locale.filterTitle} onClick={stopPropagation} />
      );
      {/*<Icon
        title={locale.filterTitle}
        type="filter"
