...
import VcMenu, { Divider, ItemGroup, SubMenu } from '../vc-menu/public_api';
...
export const menuProps = {
  ...
  prefixCls: PropTypes.string.def('salus-menu'),
...
const Menu = {
  name: 'SlMenu',
  props: menuProps,
  Divider: { ...Divider, name: 'SlMenuDivider' },
  Item: { ...Item, name: 'SlMenuItem' },
  SubMenu: { ...SubMenu, name: 'SlSubMenu' },
  ItemGroup: { ...ItemGroup, name: 'SlMenuItemGroup' },
  provide() {
    return {
  ...
  methods: {
    ...
    // VTODO: not a perfect solution, looking a new way to avoid setting switchingModeFromInline in this situation
    handleMouseEnter(e) {
  ...
  render() {
    ...
    const { prefixCls, theme, getPopupContainer, scrollbar } = this.$props;
    ...
    const menuClassName = {
      ...
      // 'salus-dropdown-scrollbar': scrollbar, // 滚动条样式
    };
    ...
    const menuProps = {
      props: {
        ...
        mode: menuMode,
        prefixCls: this.$props.inDropDown ? 'salus-dropdown-menu' : prefixCls, // 如果是inDropdown，改变样式前缀
      },
      on: {
        ...$listeners,
