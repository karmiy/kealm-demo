...
import getScrollContainerList from '../_util/getScrollContainer';
...
export default {
    ...
    methods: {
        ...
        getContainer() {
            ...
            const scrollContainers = getScrollContainerList(this.$el);
            const mountNode = props.getPopupContainer
              ? props.getPopupContainer(this.$el)
              : (scrollContainers.length ? scrollContainers[0] : props.getDocument().body);
