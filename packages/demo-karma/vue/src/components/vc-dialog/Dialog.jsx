...
import Alert from '../alert/public_api';
...
export default {
    ...
    methods: {
            ...
            if (this.visible) {
                ...
                if (!visible) {
                    ...
                    if (mousePosition) {
                        ...
                        setTransformOrigin(
                            dialogNode,
                            `${mousePosition.x - elOffset.left}px ${mousePosition.y - elOffset.top}px 0px`,
                        );
                    } else {
        ...
        getDialogElement() {
            ...
            if (title || isConfirm) {
                header = (
                    <div key="header" class={`${prefixCls}-header ${prefixCls}-header-line`} ref="header">
                        <div id={this.titleId}>
                            {title}
                        </div>
                    </div>
            ...
            if (showConfiguration) {
                conf = (
                    <div>
                        <Alert type={configurationType} message={message} description={description} showIcon={showIcon} bodyStyle={{'margin':'0','border': 'none'}}></Alert>
                    </div>
                )
            }
