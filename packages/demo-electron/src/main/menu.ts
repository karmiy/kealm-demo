...
export default class MenuBuilder {
  ...
  setupDevelopmentEnvironment(): void {
    // 鼠标右键
    this._mainWindow.webContents.on('context-menu', (_, props) => {
      const { x, y } = props;
      ...
      Menu.buildFromTemplate([
        {
          ...
          click: () => {
            // 审查元素，唤起开发者工具
            this._mainWindow.webContents.inspectElement(x, y);
          },
        },
      ]).popup({ window: this._mainWindow });
    });
  }
