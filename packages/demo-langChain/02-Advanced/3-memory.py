...
def demo4_token_buffer_memory():
    ...
    # 添加一些较长的对话历史
    memory.chat_memory.add_user_message("你好，我是王五，一名对人工智能非常感兴趣的高中生。")
    memory.chat_memory.add_ai_message("你好王五！很高兴认识你。人工智能是一个非常有趣的领域，有什么具体的问题我可以帮助你解答吗？")
    memory.chat_memory.add_user_message("我想了解一下深度学习和机器学习的区别，以及如何开始学习这些内容。")
    memory.chat_memory.add_ai_message("机器学习是人工智能的一个子领域，它允许计算机系统从数据中学习而不需要明确编程。深度学习则是机器学习的一个子集，它使用多层神经网络处理复杂数据。如果你想开始学习，建议先掌握Python编程基础，然后学习数学（线性代数、概率论）和基本的机器学习算法，再过渡到深度学习框架如TensorFlow或PyTorch。")
...
def demo5_custom_memory_integration():
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", "你是一个友好的AI助手，名叫帮帮，专注于提供简短、准确的回答。你应该记住用户提供的信息，并在回答中个性化回应。"),
